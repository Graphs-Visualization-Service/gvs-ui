...
class ApplicationAction extends AbstractAction {
   ...
   */
  public ApplicationAction(String pText, Icon pIcon, char pAccelerator,
      ApplicationView pApplicationView) {

    super(pText, pIcon);
    this.applicationView = pApplicationView;
    if (pAccelerator != ' ') {
      putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(pAccelerator,
