...
public class AreaVector {
	...
	/**
	 * Adds another vector to the given vector and multiply it with a
	 * scale. This new distance vector represents a new acceleration/speed of a
	 * particle
	 * 
	 * @param v
	 * @param scale
	...
	/**
	 * Adds another vector to the given vector. Represents new
	 * speed/acceleration of a particle in the given direction
	 * 
	 * @param v
	 */
	...
	/**
	 * Returns the sum of speed in x and y direction. If this value is small, the particle will be set to fixed
	 * 
	 * @return
	 */
