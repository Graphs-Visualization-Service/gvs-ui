...
public class BinaryNode implements IBinaryNode {
	 ...
	 * @param pRightChild
	 */
	public BinaryNode(long pNodeId, String pNodeLabel, Color pLineColor,BasicStroke pLineStroke, Color pFillColor,
	  IBinaryNode pLeftChild, IBinaryNode pRightChild) {
		this.nodeId=pNodeId;
	 ...
	 */
	public BinaryNode(long pNodeId, String pNodeLabel, Color pLineColor,BasicStroke pLineStroke, Color pFillColor,
	  long pLeftChildId, long pRightChildId) {
		this.nodeId=pNodeId;
		this.nodeLabel=pNodeLabel;
		this.lineColor=pLineColor;
		this.lineStroke=pLineStroke;
	 ...
	 */
	public BinaryNode(long pNodeId, String pNodeLabel, Color pLineColor,BasicStroke pLineStroke, Color pFillColor,
	  long pLeftChildId, long pRightChildId,double pXPosition,double pYPosition) {
		this.nodeId=pNodeId;
		this.nodeLabel=pNodeLabel;
		this.lineColor=pLineColor;
		this.lineStroke=pLineStroke;
