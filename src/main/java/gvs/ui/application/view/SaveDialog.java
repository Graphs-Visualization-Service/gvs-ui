...
public class SaveDialog extends JDialog {
  ...
  public void setAvailableSession(ISessionController[] sessiontitel) {
    ...
    JLabel icon = new JLabel(
        new ImageIcon("GVS_ServerIcons\\GVSIcon_attention.JPG"));
    ...
    addItem(selection, selectGbl, selectAllButton, 0, 0, 1, 1, 0.0, 0.0, 5, 5,
        5, 5);
    addItem(selection, selectGbl, deselectButton, 0, 1, 1, 1, 0.0, 0.0, 5, 5, 5,
        5);
    addItem(selection, selectGbl, new JLabel(), 0, 2, 1, 1, 0.0, 1.0, 5, 5, 5,
        5);
