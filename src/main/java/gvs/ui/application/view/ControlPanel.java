...
public class ControlPanel extends JPanel implements ImageObserver {
	...
	private JPanel getReplayPanel() {
		...
		sliderTextField.setText("Replay Speed: " + sliderDefaultSpeed + " ms p/Pic");
		...
		slider.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent event) {
				...
				sliderTextField.setText("Replay Speed: " + source.getValue() + " ms p/Pic");
	...
	private JPanel getLayoutPanel() {
		...
		layout.setBorder(
				BorderFactory.createMatteBorder(10, 10, 10, 10, new ImageIcon("GVS_ServerIcons\\GVSIcon_hazard.gif")));
	...
	public void addVisualizationPanel(IVisualizationPanel visualPanel) {
		addItem(this, gb, (JComponent) visualPanel, 0, 0, 3, 1, 1.0, 1.0, 5, 5, 5, 5);
	}
