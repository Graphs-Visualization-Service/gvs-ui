...
public class DefaultVertex implements IDefaultVertex {
	 ...
	 * @param pFillColor
	 */
	public DefaultVertex(long pId, String pLabel, Color pLineColor, Stroke pLineStroke, Color pFillColor) {
		this.id = pId;
		this.label = pLabel;
	 ...
	 */
	public DefaultVertex(long pId, String pLabel, Color pLineColor, Stroke pLineStroke, Color pFillColor,
			double pXPosition, double pYPosition) {
	 ...
	 */
	public DefaultVertex(long pId, String pLabel, Color pLineColor, Stroke pLineStroke, Color pFillColor,
			double pXPosition, double pYPosition, boolean pIsRelative) {
		this(pId, pLabel, pLineColor, pLineStroke, pFillColor);
		this.xPosition = pXPosition;
		this.yPosition = pYPosition;
