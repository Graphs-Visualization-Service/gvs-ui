...
public class AreaDimension {
    ...
    /**
     * Returns width of dimension, used by Layout Controller to set random
     *  x points for each particle.
     * @return
     */
    ...
    /**
     * Returns height of dimension, used by Layout Controller to set random
     * y points for each particle.
     * @return
     */
