...
public class GraphModel {
	 ...
	 */
	public GraphModel(String pGraphLabel, Image pBackgroundImage, Vector pVertizes, Vector pEdges,
			int pMaxLabelLength) {
	 ...
	 * @param pMaxLabelLength
	 */
	public GraphModel(String pGraphLabel, Color pBackgroundColor, Vector pVertizes, Vector pEdges,
			int pMaxLabelLength) {
		this.graphLabel = pGraphLabel;
