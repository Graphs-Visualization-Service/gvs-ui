...
public class ApplicationView extends JFrame implements Observer {
	...
	private JMenuBar initMenubar() {
		...
		ApplicationAction saveAction = new ApplicationAction("Save", new ImageIcon(
				...
				"GVS_ServerIcons/GVSIcon_save.JPG"), 'S', this);
		ApplicationAction loadAction = new ApplicationAction("Load", new ImageIcon("GVS_ServerIcons\\GVSIcon_load.JPG"),
				'L', this);
		...
		ApplicationAction graphLayoutAction = new ApplicationAction("Graph", null, ' ', this);

		ApplicationAction treeLayoutAction = new ApplicationAction("Tree", null, ' ', this);
		...
		JRadioButtonMenuItem radioHardLayout = new JRadioButtonMenuItem(hardLayoutAction);
		radioHardLayout.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				layoutOption(false);
			}
		});
		JRadioButtonMenuItem radioSoftLayout = new JRadioButtonMenuItem(softLayoutAction);
		...
		JRadioButtonMenuItem clutterSplitterLayout = new JRadioButtonMenuItem(treeLayoutAction);
	...
	private void generateHeaderPanel() {
		...
		deleteButton = new JButton(new ImageIcon("GVS_ServerIcons\\GVSIcon_delete.JPG"));
	...
	public void saveSesssions(boolean isExitRequested) {
		...
		saveDialog.setLocation((screenSize.width - window.width) / 2, (screenSize.height - window.height) / 2);
