...
public class Configuration {
	...
	private BasicStroke defaultStroke = new BasicStroke(1, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 1,
			new float[] { 1, 0 }, 0);
	 ...
	 */
	public synchronized BasicStroke getLineObject(String pLinestyle, String pLineThickness) {
		...
		if (dash == null || width == null) {
			...
			return new BasicStroke(width, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 1, dash, 0);
		}
	}
		...
		while (colorIt.hasNext()) {
			...
			if (eColor != null) {
				...
				if (eR != null && eG != null && eB != null) {
					...
					commonLogger.debug("New Color: " + name + " : " + r + "/" + g + "/" + b);
				} else {
