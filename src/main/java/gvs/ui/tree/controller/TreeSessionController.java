...
/**
 * The session contoller reacts on user input events and implements most of
...
public class TreeSessionController implements ITreeSessionController {
	...
	public TreeSessionController(long pSessionId, String pSessionName, TreeModel pTreeModel) {
	 ...
	 * @param pTreeModels
	 */
	public TreeSessionController(long pSessionId, String pSessionName, Vector pTreeModels) {
		this.clientSessionId = pSessionId;
		this.sessionName = pSessionName;
	...
	public boolean validateNavigation(long pRequestedModelId) {
		if ((pRequestedModelId >= 1) && (pRequestedModelId <= (treeModels.size()))) {
