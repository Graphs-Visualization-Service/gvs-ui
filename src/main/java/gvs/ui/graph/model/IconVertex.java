...
public class IconVertex implements IIconVertex {
	 ...
	 * @param pIcon
	 */
	public IconVertex(long pId, String pLabel, Color pLineColor, Stroke pLineStroke, Image pIcon) {
		this.id = pId;
		this.label = pLabel;
	 ...
	 * @param pYPosition
	 */
	public IconVertex(long pId, String pLabel, Color pLineColor, Stroke pLineStroke, Image pIcon, double pXPosition,
			double pYPosition) {
